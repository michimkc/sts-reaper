...
public abstract class SoulShiftBlockRune {
    ...
    public SoulShiftBlockRune(String imgUrl, String runeID, String name, String description) {
    ...
    public abstract SoulShiftBlockRune makeCopy();
