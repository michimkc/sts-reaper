...
public class RevengePower extends AbstractPower implements CloneablePowerInterface {
    ...
    public static final Logger logger = LogManager.getLogger(RevengePower.class.getName());

    public static final String POWER_ID = DefaultMod.makeID("RevengePower");
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("revenge_power84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("revenge_power32.png"));

    private ArrayList<DamageAction> damageList;

    public RevengePower(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    public AbstractPower makeCopy() {
        return new RevengePower(owner, source, amount);
    }
}
