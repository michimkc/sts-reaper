...
public class HemoplaguePower extends AbstractBleedPower implements CloneablePowerInterface {

    public static final Logger logger = LogManager.getLogger(HemoplaguePower.class.getName());

    public static final String POWER_NAME = "HemoplaguePower";
    public static final PowerType POWER_TYPE = PowerType.BUFF;
    public static final boolean POWER_ISTURNBASED = false;
    public static final int POWER_AMOUNT = 0;
    public int raiseAmount;

    public HemoplaguePower(final AbstractCreature owner, final AbstractCreature source, int raiseAmt) {
    ...
    public AbstractPower makeCopy() {
        return new HemoplaguePower(owner, source, raiseAmount);
    }
}
